...
## What is a Geoduck?
![geoduck]("https://raw.githubusercontent.com/course-fish546-2023/olivia-geoduck/main/Holding-Geoduck-1-770x1024.jpeg")
...
head(Pgen_Manila_goslims)
kable(Pgen_Manila_goslims[1:5,], caption= "Manila db blast result")
```
...
head(species_unique)
```
- done with species data organization!
...
kable(Tis_normal[1:5,], caption = "tissue data normalized for heatmap")
```
